...
const FeedbackCard = ({ content, name, title, img }) => {
  return (
    <div className="justify-betwenn mr-b feedback-card my-5 flex max-w-[370px] flex-col rounded-[20px] px-10 py-12 sm:mr-5 md:mr-10">
      <img
        src={quotes}
        alt="double_quotes"
        className="h-[72px] w-[42px] object-contain"
      />
